const String dM_sans_black = "DM_Sans_Black";
const String dM_sans_bold = "DM_Sans_Bold";
const String dM_sans_extraBold = "DM_Sans_ExtraBold";
const String dM_sans_extraLight = "DM_Sans_ExtraLight";
const String dM_sans_light = "DM_Sans_Light";
const String dM_sans_regular = "DM_Sans_Regular";

...
import '../../controller/UpdatedProfileController.dart';
...
class _ProfileScreenState extends State<UpdateProfile>
  ...
  void initState() {
    controller.tabController =
        TabController(vsync: this, length: 2, initialIndex: selectedTabIndex);
    super.initState();
  }
          ...
          child: Column(children: [
            ...
            Expanded(
              child: TabBarView(
                ...
                children: [const UpdateBusinessProfileScreen(), Container()],
              ),
            ),
          ])),
    );
